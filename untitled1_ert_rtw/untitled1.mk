...
## Generated on : Tue Feb 25 12:13:50 2020
...
INCLUDES_BUILDINFO = -I$(START_DIR) -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2019b/toolbox/realtime/targets/linux/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2019b/toolbox/realtime/targets/linux/blocks/sfcn/include -I$(START_DIR)/untitled1_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2019b/toolbox/realtime/targets/linux/blocks/sfcn/src -I$(MATLAB_ROOT)/toolbox/ros/slros/include -I$(MATLAB_ROOT)/toolbox/target/codertarget/rtos/inc
...
OBJS = MW_SDL_video_display.c.o v4l2_capture.c.o v4l2_capture_linux.c.o untitled1.cpp.o untitled1_data.cpp.o ext_svr.c.o updown.c.o ext_work.c.o rtiostream_utils.c.o rtiostream_interface.c.o rtiostream_tcpip.c.o linuxinitialize.cpp.o slros_busmsg_conversion.cpp.o slros_initialize.cpp.o slros_generic_param.cpp.o
...
CPP_LDFLAGS_SKIPFORSIL = -lSDL -lrt
...
CPP_SHAREDLIB_LDFLAGS_SKIPFORSIL = -lSDL -lrt
...
SHAREDLIB_LDFLAGS_SKIPFORSIL = -lSDL -lrt
...
%.c.o : C:/ProgramData/MATLAB/SupportPackages/R2019b/toolbox/realtime/targets/linux/blocks/sfcn/src/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.s.o : C:/ProgramData/MATLAB/SupportPackages/R2019b/toolbox/realtime/targets/linux/blocks/sfcn/src/%.s
	$(AS) $(ASFLAGS) -o $@ $<


%.cpp.o : C:/ProgramData/MATLAB/SupportPackages/R2019b/toolbox/realtime/targets/linux/blocks/sfcn/src/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
...
MW_SDL_video_display.c.o : C:/ProgramData/MATLAB/SupportPackages/R2019b/toolbox/realtime/targets/linux/src/MW_SDL_video_display.c
	$(CC) $(CFLAGS) -o $@ $<


v4l2_capture.c.o : C:/ProgramData/MATLAB/SupportPackages/R2019b/toolbox/realtime/targets/linux/blocks/sfcn/src/v4l2_capture.c
	$(CC) $(CFLAGS) -o $@ $<


v4l2_capture_linux.c.o : C:/ProgramData/MATLAB/SupportPackages/R2019b/toolbox/realtime/targets/linux/blocks/sfcn/src/v4l2_capture_linux.c
	$(CC) $(CFLAGS) -o $@ $<


ert_main.cpp.o : $(START_DIR)/untitled1_ert_rtw/ert_main.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


untitled1.cpp.o : $(START_DIR)/untitled1_ert_rtw/untitled1.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


untitled1_data.cpp.o : $(START_DIR)/untitled1_ert_rtw/untitled1_data.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
...
slros_busmsg_conversion.cpp.o : $(START_DIR)/untitled1_ert_rtw/slros_busmsg_conversion.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


slros_initialize.cpp.o : $(START_DIR)/untitled1_ert_rtw/slros_initialize.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
