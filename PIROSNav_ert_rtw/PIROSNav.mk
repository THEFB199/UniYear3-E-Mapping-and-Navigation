###########################################################################
## Makefile generated for Simulink model 'PIROSNav'. 
## 
## Makefile     : PIROSNav.mk
## Generated on : Fri Feb 07 11:21:11 2020
## MATLAB Coder version: 4.3 (R2019b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/PIROSNav.elf
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/PIROSNav.elf
...
DEFINES_STANDARD = -DMODEL=PIROSNav -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.c.o : C:/ProgramData/MATLAB/SupportPackages/R2019b/toolbox/realtime/targets/raspi/server/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.s.o : C:/ProgramData/MATLAB/SupportPackages/R2019b/toolbox/realtime/targets/raspi/server/%.s
	$(AS) $(ASFLAGS) -o $@ $<


%.cpp.o : C:/ProgramData/MATLAB/SupportPackages/R2019b/toolbox/realtime/targets/raspi/server/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


%.c.o : $(START_DIR)/PIROSNav_ert_rtw/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.s.o : $(START_DIR)/PIROSNav_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o $@ $<


%.cpp.o : $(START_DIR)/PIROSNav_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
...
ert_main.cpp.o : $(START_DIR)/PIROSNav_ert_rtw/ert_main.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


PIROSNav.cpp.o : $(START_DIR)/PIROSNav_ert_rtw/PIROSNav.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


PIROSNav_data.cpp.o : $(START_DIR)/PIROSNav_ert_rtw/PIROSNav_data.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


rtGetInf.cpp.o : $(START_DIR)/PIROSNav_ert_rtw/rtGetInf.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


rtGetNaN.cpp.o : $(START_DIR)/PIROSNav_ert_rtw/rtGetNaN.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


rt_nonfinite.cpp.o : $(START_DIR)/PIROSNav_ert_rtw/rt_nonfinite.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
...
slros_busmsg_conversion.cpp.o : $(START_DIR)/PIROSNav_ert_rtw/slros_busmsg_conversion.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


slros_initialize.cpp.o : $(START_DIR)/PIROSNav_ert_rtw/slros_initialize.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
