...
typedef struct {
  ...
  SL_Bus_PIROSNavRec_sensor_msgs_Joy In1;// '<S19>/In1'
  SL_Bus_PIROSNavRec_sensor_msgs_Joy b_varargout_2;
  real_T Qw[144];
  real_T Ppost[144];
  real_T H[72];
  real_T K[72];
  ...
  real_T h[9];
  real_T ze[6];
  SL_Bus_PIROSNavRec_geometry_msgs_Twist In1_h;// '<S18>/In1'
  SL_Bus_PIROSNavRec_geometry_msgs_Twist b_varargout_2_c;
  real_T psquared[4];
...
struct P_PIROSNavRec_T_ {
  ...
  SL_Bus_PIROSNavRec_sensor_msgs_Joy Out1_Y0;// Computed Parameter: Out1_Y0
                                                //  Referenced by: '<S19>/Out1'

  SL_Bus_PIROSNavRec_sensor_msgs_Joy Constant_Value;// Computed Parameter: Constant_Value
                                                       //  Referenced by: '<S8>/Constant'

  SL_Bus_PIROSNavRec_geometry_msgs_Twist Out1_Y0_a;// Computed Parameter: Out1_Y0_a
                                                      //  Referenced by: '<S18>/Out1'

  SL_Bus_PIROSNavRec_geometry_msgs_Twist Constant_Value_h;// Computed Parameter: Constant_Value_h
...
//
//  '<Root>' : 'PIROSNavRec'
//  '<S1>'   : 'PIROSNavRec/Arbitration'
//  '<S2>'   : 'PIROSNavRec/Counter Limited'
//  '<S3>'   : 'PIROSNavRec/ForwardBack_LeftRight'
//  '<S4>'   : 'PIROSNavRec/GetRosMessage'
//  '<S5>'   : 'PIROSNavRec/GetRosMessage1'
//  '<S6>'   : 'PIROSNavRec/PiSenseHat'
//  '<S7>'   : 'PIROSNavRec/Subscribe'
//  '<S8>'   : 'PIROSNavRec/Subscribe1'
//  '<S9>'   : 'PIROSNavRec/Subsystem'
//  '<S10>'  : 'PIROSNavRec/Counter Limited/Increment Real World'
//  '<S11>'  : 'PIROSNavRec/Counter Limited/Wrap To Zero'
//  '<S12>'  : 'PIROSNavRec/GetRosMessage1/MATLAB Function'
//  '<S13>'  : 'PIROSNavRec/GetRosMessage1/MATLAB Function1'
//  '<S14>'  : 'PIROSNavRec/GetRosMessage1/XboxControllerMappings '
//  '<S15>'  : 'PIROSNavRec/PiSenseHat/MATLAB Function'
//  '<S16>'  : 'PIROSNavRec/PiSenseHat/MATLAB Function1'
//  '<S17>'  : 'PIROSNavRec/PiSenseHat/MATLAB Function2'
//  '<S18>'  : 'PIROSNavRec/Subscribe/Enabled Subsystem'
//  '<S19>'  : 'PIROSNavRec/Subscribe1/Enabled Subsystem'
