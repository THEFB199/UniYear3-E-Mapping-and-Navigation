...
// Conversions between SL_Bus_PIROSNavRec_geometry_msgs_Twist and geometry_msgs::Twist

void convertFromBus(geometry_msgs::Twist* msgPtr, SL_Bus_PIROSNavRec_geometry_msgs_Twist const* busPtr)
{
...
void convertToBus(SL_Bus_PIROSNavRec_geometry_msgs_Twist* busPtr, geometry_msgs::Twist const* msgPtr)
{
  const std::string rosMessageType("geometry_msgs/Twist");
...
// Conversions between SL_Bus_PIROSNavRec_geometry_msgs_Vector3 and geometry_msgs::Vector3
...
// Conversions between SL_Bus_PIROSNavRec_ros_time_Time and ros::Time
...
// Conversions between SL_Bus_PIROSNavRec_sensor_msgs_Joy and sensor_msgs::Joy
...
// Conversions between SL_Bus_PIROSNavRec_std_msgs_Header and std_msgs::Header
