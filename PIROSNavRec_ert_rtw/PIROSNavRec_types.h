...
#ifndef DEFINED_TYPEDEF_FOR_SL_Bus_PIROSNavRec_ros_time_Time_
#define DEFINED_TYPEDEF_FOR_SL_Bus_PIROSNavRec_ros_time_Time_

// MsgType=ros_time/Time
typedef struct {
  real_T Sec;
  real_T Nsec;
} SL_Bus_PIROSNavRec_ros_time_Time;

#endif

#ifndef DEFINED_TYPEDEF_FOR_SL_Bus_PIROSNavRec_std_msgs_Header_
#define DEFINED_TYPEDEF_FOR_SL_Bus_PIROSNavRec_std_msgs_Header_
...
typedef struct {
  ...
  // MsgType=ros_time/Time
  SL_Bus_PIROSNavRec_ros_time_Time Stamp;
} SL_Bus_PIROSNavRec_std_msgs_Header;

#endif

#ifndef DEFINED_TYPEDEF_FOR_SL_Bus_PIROSNavRec_sensor_msgs_Joy_
#define DEFINED_TYPEDEF_FOR_SL_Bus_PIROSNavRec_sensor_msgs_Joy_
...
typedef struct {
  ...
  // MsgType=std_msgs/Header
  SL_Bus_PIROSNavRec_std_msgs_Header Header;
...
#ifndef typedef_struct_T_PIROSNavRec_T
#define typedef_struct_T_PIROSNavRec_T
...
typedef struct {
  ...
  real_T c;
  real_T d;
} struct_T_PIROSNavRec_T;

#endif                                 //typedef_struct_T_PIROSNavRec_T
...
// Custom Type definition for MATLAB Function: '<S6>/MATLAB Function'
#ifndef typedef_cell_wrap_3_PIROSNavRec_T
#define typedef_cell_wrap_3_PIROSNavRec_T

typedef struct {
  uint32_T f1[8];
} cell_wrap_3_PIROSNavRec_T;

#endif                                 //typedef_cell_wrap_3_PIROSNavRec_T
...
typedef struct {
  ...
  cell_wrap_3_PIROSNavRec_T inputVarSize[3];
