...
static uint_T rtDataTypeSizes[] = {
  ...
  sizeof(SL_Bus_PIROSNavRec_ros_time_Time),
...
static DataTypeTransition rtBTransitions[] = {
  { (char_T *)(&PIROSNavRec_B.In1), 19, 0, 1 },

  { (char_T *)(&PIROSNavRec_B.In1_h), 15, 0, 1 },

  { (char_T *)(&PIROSNavRec_B.out), 0, 0, 7 },

  { (char_T *)(&PIROSNavRec_B.uDLookupTable9), 1, 0, 13 },
  ...
  { (char_T *)(&PIROSNavRec_DW.EnabledSubsystem_SubsysRanBC), 2, 0, 4 }
};
...
static DataTypeTransition rtPTransitions[] = {
  ...
  { (char_T *)(&PIROSNavRec_P.Out1_Y0), 19, 0, 1 },

  { (char_T *)(&PIROSNavRec_P.Constant_Value), 19, 0, 1 },

  { (char_T *)(&PIROSNavRec_P.Out1_Y0_a), 15, 0, 1 },

  { (char_T *)(&PIROSNavRec_P.Constant_Value_h), 15, 0, 1 },

  { (char_T *)(&PIROSNavRec_P.Constant1_Value), 0, 0, 13 },

  { (char_T *)(&PIROSNavRec_P.Constant2_Value_d), 1, 0, 42 },
