...
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/PI_UDP_Recieve.elf
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/PI_UDP_Recieve.elf
...
%.c.o : $(START_DIR)/PI_UDP_Recieve_ert_rtw/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.s.o : $(START_DIR)/PI_UDP_Recieve_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o $@ $<


%.cpp.o : $(START_DIR)/PI_UDP_Recieve_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
...
ert_main.cpp.o : $(START_DIR)/PI_UDP_Recieve_ert_rtw/ert_main.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


PI_UDP_Recieve.cpp.o : $(START_DIR)/PI_UDP_Recieve_ert_rtw/PI_UDP_Recieve.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


PI_UDP_Recieve_data.cpp.o : $(START_DIR)/PI_UDP_Recieve_ert_rtw/PI_UDP_Recieve_data.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
...
slros_busmsg_conversion.cpp.o : $(START_DIR)/PI_UDP_Recieve_ert_rtw/slros_busmsg_conversion.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


slros_initialize.cpp.o : $(START_DIR)/PI_UDP_Recieve_ert_rtw/slros_initialize.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
